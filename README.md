...
Đồ án tốt nghiệp này tập trung vào việc phát triển một **nền tảng học tập thông minh tích hợp AI và IoT** (AIoT Learning Platform), nhằm nâng cấp hệ thống E-Learning hiện có từ đồ án chuyên ngành lên một giải pháp hoàn chỉnh và chuyên nghiệp. Hệ thống không chỉ cung cấp các tính năng học tập trực tuyến cơ bản mà còn tích hợp các công nghệ tiên tiến như Trí tuệ nhân tạo (AI) cho việc gợi ý khóa học, giám sát thi cử, và nhận diện khuôn mặt; cùng với Internet of Things (IoT) cho điểm danh thông minh và giám sát môi trường học tập.

Hệ thống được thiết kế với kiến trúc phân tán, sử dụng Supabase làm database chính và VPS với MySQL cho các dịch vụ AI và IoT, đảm bảo khả năng mở rộng và hiệu suất cao.
...
Trong bối cảnh chuyển đổi số giáo dục và xu hướng Industry 5.0, việc ứng dụng công nghệ AI và IoT vào giáo dục đang trở thành một xu hướng tất yếu. Các hệ thống E-Learning truyền thống thường thiếu tính cá nhân hóa, không có khả năng gợi ý thông minh, và chưa tích hợp các công nghệ điểm danh tự động hay giám sát môi trường học tập.

### 1.2. Mục tiêu nghiên cứu

#### Mục tiêu tổng quát
Xây dựng một nền tảng học tập thông minh tích hợp AI và IoT, cung cấp trải nghiệm học tập cá nhân hóa, tự động hóa quy trình quản lý, và tối ưu hóa môi trường học tập.
...
3. **Triển khai hệ thống điểm danh tự động** thông qua IoT (vân tay) và AI (nhận diện khuôn mặt).
4. **Xây dựng hệ thống giám sát thi cử** sử dụng AI Proctoring để đảm bảo tính công bằng và minh bạch.
