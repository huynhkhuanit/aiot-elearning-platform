...
class Settings(BaseSettings):
    ...
    FACE_TOUCH_DEPTH_AREA_SOFT_MAX: float = 0.95
    FACE_TOUCH_DEPTH_AREA_HARD_MAX: float = 1.60
    FACE_TOUCH_DEPTH_DIAGONAL_SOFT_MAX: float = 0.82
    FACE_TOUCH_DEPTH_DIAGONAL_HARD_MAX: float = 1.18
    FACE_TOUCH_DEPTH_Z_SOFT: float = 0.14
    FACE_TOUCH_DEPTH_Z_HARD: float = 0.38
    FACE_TOUCH_DEPTH_PENALTY_START: float = 0.35
    FACE_TOUCH_DEPTH_PENALTY_FULL: float = 0.72
    FACE_TOUCH_DEPTH_TOUCH_FLOOR: float = 0.12
    FACE_TOUCH_DEPTH_NEAR_FLOOR: float = 0.55
