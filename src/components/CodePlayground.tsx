        ...
        case "html":
            return (
                ...
                >
                    ...
                    />
                    <path
                        d="M16 13.407h4.09l.282-3.165H16V7.151h7.75l-.074.83-.759 8.517H16v-3.091z"
                        fill="#EBEBEB"
                    />
                    <path
                    ...
                    />
                    <path
                        d="M19.82 16.498l-.372 4.166-3.434.927v3.216l6.318-1.751.046-.522.537-6.036h-3.095z"
                        fill="#FFF"
                    />
                    <path
                        d="M16.003 13.407v3.091h-3.399l-.199-2.232-.045-.83-.074-.829h3.717z"
                        fill="#FFF"
                    />
                </svg>
            );
        case "css":
            return (
                ...
                >
                    ...
                    />
                    <path
                        d="M19.827 16.151l-.372 4.139-3.426.925v3.216l6.292-1.743.046-.522.726-8.015h-7.749v3h4.483z"
                        fill="#FFF"
                    />
                    <path
                        d="M16.011 6.935v3.091h-7.611l-.062-.695-.141-1.567-.074-.829h7.888z"
                        fill="#EBEBEB"
                    />
                    <path
                        d="M16 13.191v3.091H9.567l-.062-.695-.141-1.567-.074-.829H16z"
                        fill="#EBEBEB"
                    />
                </svg>
            );
        ...
        case "cpp":
            return (
                ...
                >
                    ...
                    <path
                        d="M16 10.5c-1.933 0-3.5 1.567-3.5 3.5s1.567 3.5 3.5 3.5c.816 0 1.565-.28 2.157-.748l-1.407-2.002a1.5 1.5 0 11-.75-2.798V10.5zm5 1v1.5h1.5V14h-1.5v1.5H19V14h-1.5v-1.5H19v-1.5h1.5zm4 0v1.5H26V14h-1v1.5h-1.5V14H22v-1.5h1.5v-1.5H25z"
                        fill="#FFF"
                    />
                </svg>
            );
...
export default function CodePlayground({
    ...
    const [activeLanguage, setActiveLanguage] =
        useState<keyof CodeState>(initialLanguage);
    ...
    useEffect(() => {
        ...
        validationTimerRef.current = setTimeout(() => {
            ...
            if (
                ...
                const problemsClosed = sessionStorage.getItem(
                    `problems_closed_${lessonId}`,
                );
                if (!problemsClosed) {
                    setPreviewTab("problems");
                }
    ...
    const handleEditorDidMount: OnMount = (
        ...
        monaco.editor.setTheme(
            theme === "dark" ? "codeplayground-dark" : "codeplayground-light",
        );
            ...
            provideCompletionItems: (model: any, position: any) => {
                ...
                const cssSnippets = [
                    ...
                    },
                    {
                        ...
                        detail: "Transition effect",
                    },
                    {
                        label: "transform",
                        insertText: "transform: ${1:translate}($2);",
                    ...
                    },
                    {
                        label: "box-shadow",
                        insertText:
                            "box-shadow: ${1:0} ${2:4px} ${3:6px} rgba(0, 0, 0, ${4:0.1});",
                        detail: "Box shadow",
                    },
                    {
                        label: "gradient",
                        insertText:
                            "background: linear-gradient(${1:to right}, ${2:#fff}, ${3:#000});",
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className={`flex items-center justify-between px-4 py-2.5 ${theme === "dark" ? "bg-[#323233]" : "bg-[#f3f3f3]"} border-b ${borderColor}`}
                >
                    <div className="flex items-center space-x-3">
                        <Code2
                            className={`w-4 h-4 ${theme === "dark" ? "text-blue-400" : "text-blue-600"}`}
                        />
                        <h2 className={`text-xs font-medium ${textPrimary}`}>
                            Code Playground
                        </h2>
                ...
                <div
                    className={`flex items-center justify-between ${theme === "dark" ? "bg-[#252526]" : "bg-[#f3f3f3]"} border-b ${borderColor}`}
                >
                    <div className="flex overflow-x-auto">
                        {(
                            Object.keys(LANGUAGE_LABELS) as Array<
                                keyof CodeState
                            >
                        ).map((lang) => (
                            <button
                            ...
                            >
                                ...
                                />
                                <span
                                    className={`whitespace-nowrap ${activeLanguage === lang ? "font-medium" : ""}`}
                                >
                                    {lang === "javascript"
                                        ? "JS"
                    ...
                    <div className="flex items-center space-x-0.5 px-2 py-1">
                        ...
                        <button
                            ...
                            title={
                                showAIChat ? "Ẩn AI Chat" : "AI Chat Assistant"
                            }
                        >
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div
                        className={`flex-1 flex flex-col overflow-hidden ${showAIChat ? "min-w-0" : ""}`}
                    >
                        {showSplitView ? (
                            <>
                                {/* Code Editor with Line Numbers - TOP */}
                                <div
                                    className={`flex-1 flex flex-col border-b ${borderColor} overflow-hidden`}
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`${textTertiary} text-xs`}
                                        >
                                            {
                                ...
                                {showPreview && (
                                    <div className="h-[35vh] flex flex-col overflow-hidden">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {consoleLogs.length > 0 && (
                                                    <span
                                                        className={`ml-1 px-1.5 py-0.5 ${theme === "dark" ? "bg-[#007acc]" : "bg-[#0078d4]"} text-white text-[10px] rounded-full font-semibold`}
                                                    >
                                                        {consoleLogs.length}
                                                    </span>
                                                )}
                                            ...
                                            {(activeLanguage === "html" ||
                                                ...
                                                validationErrors.length > 0 && (
                                                    ...
                                                    >
                                                        ...
                                                        <span>Problems</span>
                                                        <span
                                                            className={`ml-1 px-1.5 py-0.5 ${theme === "dark" ? "bg-red-600" : "bg-red-500"} text-white text-[10px] rounded-full font-semibold`}
                                                        >
                                                            {
                                        ...
                                        <div
                                            className={`flex-1 overflow-auto ${previewTab === "browser" ? "bg-white" : "hidden"}`}
                                        >
                                            <iframe
                                                ref={iframeRef}
                                                srcDoc={previewHTML}
                                        ...
                                        {previewTab === "console" && (
                                            <div
                                                className={`flex-1 overflow-auto ${theme === "dark" ? "bg-[#1e1e1e]" : "bg-gray-900"} p-2`}
                                            >
                                                {consoleLogs.length === 0 ? (
                                                    <div className="text-gray-500 text-sm font-mono p-2">
                                                        Console is empty. Run
                                                        JavaScript code to see
                                                        output here.
                                                    </div>
                                                ) : (
                                        ...
                                        {previewTab === "problems" &&
                                            validationErrors.length > 0 && (
                                                <div
                                                    className={`flex-1 overflow-auto ${theme === "dark" ? "bg-[#1e1e1e]" : "bg-white"}`}
                                                >
                                                    {validationErrors.length ===
                                                    0 ? (
                                                        <div
                                                            className={`text-sm font-mono p-4 ${textSecondary}`}
                                                        >
                                                            No problems
                                                            detected.
                                                        </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        onClick={() => {
                                                                            if (
                                                                                ...
                                                                                codeEditorRef.current.revealLineInCenter(
                                                                                    error.line,
                                                                                );
                                                                                ...
                                                                                <div className="flex items-center gap-1.5 mb-0.5 flex-wrap">
                                                                                    ...
                                                                                    {error.code && (
                                                                                        <>
                                                                                            ...
                                                                                            <span
                                                                                                className={`text-xs ${textTertiary} font-mono`}
                                                                                            >
                                                                                                {
                                                                                                    error.code
                                                                                                }
                    ...
                    {showAIChat && (
                        <div
                            className={`w-[400px] flex-shrink-0 border-l ${borderColor} overflow-hidden`}
                        >
                            <AIErrorBoundary fallbackMessage="AI Agent tạm thời không hoạt động. Bạn vẫn có thể tiếp tục code bình thường.">
                                <AIAgentPanel
                ...
                >
                    <div className="flex items-center space-x-4">
                        ...
                        <span className="opacity-90">
                            Ln{" "}
                            {codeEditorRef.current?.getPosition()?.lineNumber ||
                                code[activeLanguage].split("\n").length}
                            , Col{" "}
                            {codeEditorRef.current?.getPosition()?.column || 1}
                        </span>
            ...
            {showAIReview && (
                <div className="fixed inset-0 z-[60] bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
                    ...
                    >
                        <div
                            className={`flex items-center justify-between px-6 py-4 ${bgSecondary} border-b ${borderColor}`}
                        >
                            <div className="flex items-center space-x-3">
                        ...
                        <div className="overflow-y-auto max-h-[calc(80vh-80px)] p-6">
                            {isLoadingReview ? (
                                <div className="flex flex-col items-center justify-center py-12 space-y-4">
                                    ...
                                    <p
                                        className={`text-sm ${textSecondary} animate-pulse`}
                                    >
                                ...
                                <div className="space-y-6">
                                    <div
                                        className={`${bgSecondary} rounded-lg p-6 border ${borderColor}`}
                                    >
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <h4
                                                    className={`text-sm font-medium ${textSecondary} mb-1`}
                                                >
                                                    Điểm tổng quan
                                                </h4>
                                                <div className="flex items-baseline space-x-2">
                                                    ...
                                                    >
                                                        {aiReviewData.score.toFixed(
                                                            1,
                                                        )}
                                                    </span>
                                                    <span
                                                        className={`text-2xl ${textSecondary}`}
                                                    >
                                                        /10
                                                    </span>
                                                </div>
                                    ...
                                    <div>
                                        <h4
                                            className={`text-sm font-semibold ${textPrimary} mb-3 flex items-center space-x-2`}
                                        >
                                            <span className="w-2 h-2 bg-green-500 rounded-full"></span>
                                            <span>Điểm mạnh</span>
                                        </h4>
                                        <ul className="space-y-2">
                                            {aiReviewData.pros.map(
                                                (pro, index) => (
                                                    <li
                                                        key={index}
                ...
                <div className="fixed inset-0 z-[60] bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            <div
                                className={`${bgSecondary} rounded-lg p-4 border-l-4 border-orange-500`}
                            >
                                <p
                                    className={`${textPrimary} text-sm leading-relaxed`}
                                >
                                    Bạn chưa viết code gì trong tab{" "}
                                    <strong>
                                        {LANGUAGE_LABELS[activeLanguage]}
                                    </strong>{" "}
                                    hiện tại.
                            ...
                            <div className={`${bgSecondary} rounded-lg p-4`}>
                                ...
                                <ul
                                    className={`space-y-2 ${textSecondary} text-sm`}
                                >
                                    ...
                                    <li className="flex items-start space-x-2">
                                        ...
                                        <span>
                                            AI sẽ phân tích và đưa ra gợi ý cải
                                            thiện code của bạn
                                        </span>
                                    </li>
                                </ul>
