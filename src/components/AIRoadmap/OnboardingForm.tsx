...
const stepDescriptions = [
    "Cho chúng tôi biết đối tượng của bạn",
...
/**
 * Derive a human-readable currentRole string from audience data.
 */
...
export default function OnboardingForm({
    ...
    const canGoNext = () => {
        switch (currentStep) {
            case 1: {
                // Audience step: validate based on type
                ...
                switch (formData.audienceType) {
                    ...
                    case "non-worker":
                        return true; // No sub-field required
                    case "student":
