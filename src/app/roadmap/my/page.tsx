    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div>
                            ...
                            <p className="text-gray-500 text-sm">
                                Quản lý tiến độ và kỹ năng của bạn
                            </p>
                        </div>
            ...
            <PageContainer size="lg" className="py-6">
                {/* Loading State */}
                {isLoading && <PageLoading variant="section" />}
                            ...
                            {roadmaps.map((roadmap) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div
                                                className={`bg-white rounded-xl border ${style.border} h-full transition-shadow hover:shadow-md overflow-hidden`}
                                            >
                                                <div className="p-4">
                                                    {/* Header */}
                                                    <div className="flex items-start gap-2.5 mb-3">
                                                        <div
                                                            className={`w-9 h-9 rounded-lg ${style.bg} flex items-center justify-center flex-shrink-0 mt-0.5`}
                                                        >
                                                            <Icon
                                                                className={`w-[18px] h-[18px] ${style.color}`}
                                                            />
                                                        </div>
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <div className="text-[10px] text-gray-500 truncate mt-0.5 font-medium">
                                                                {roadmap.description ||
                                                                    `Lộ trình học tập ${roadmap.title}`}
                                                            </div>
                                                        </div>
                                                    </div>
